...
export const routes: Routes = [
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    data: { permission: 'dropdowns.manage' },
    loadChildren: () => import('./categories/category-manager.module').then((m) => m.CategoryManagerModule),
  },
  {
    path: 'admin/referrals',
    canActivate: [AuthGuard],
    data: { permission: 'referrals.manage' },
    loadChildren: () => import('./referrals/referral-settings/referral-settings.module').then((m) => m.ReferralSettingsModule),
  },
  {
    path: 'admin/coupons',
    canActivate: [AuthGuard],
